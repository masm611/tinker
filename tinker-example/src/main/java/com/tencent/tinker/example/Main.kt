...
class MainApp : Tinker.App() {
    ...
    override fun getAppLikeClassName(): String =
        "com.tencent.tinker.example.MainAppLike"

    override fun getLoadCallback(): Tinker.Callback<Tinker.TaskSummary.Load> =
        Callbacks.Load(this)

    override fun getDeployCallback(): Tinker.Callback<Tinker.TaskSummary.Deploy> =
        Callbacks.Deploy(this)

    override fun getCleanCallback(): Tinker.Callback<Tinker.TaskSummary.Clean> =
